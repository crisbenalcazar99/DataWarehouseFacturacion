...
from etl.extract.db_extractor import DatabaseExtractor, CsvExtractor
from etl.load.db_load import DWBatchedLoader
from etl.transform.dtypes_massive import DtypeDateTransform
...
class PipelineConfig:
    def __init__(self, app_config):
        ...
        self.CSV_PATH: str = Path(__file__).parents[2] / "include" / "archivos" / "facturas_excluidas.csv"
